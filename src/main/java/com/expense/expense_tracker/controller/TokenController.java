...
import com.expense.expense_tracker.request.AuthRequestDTO;
...
public class TokenController {
    ...
    public ResponseEntity AuthenticateAndGetToken(@RequestBody AuthRequestDTO authRequestDTO){
        ...
        if(authentication.isAuthenticated()){
            ...
            return new ResponseEntity(JwtResponseDTO.builder().accessToken(jwtService.GenerateToken(authRequestDTO.getUsername())), HttpStatus.OK);
        }else{
